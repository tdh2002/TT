...
static const gchar *content_ch202[] = {
	/* 二级菜单第0页下的第2页三级菜单 */
	"返回", "开始", "类型", "模式", NULL, "清除校准", "选择标准","重新设置", "角度","增益", "开始", "范围", "回波类型", "半径1", "半径2", "深度1", "深度2", "厚度1", "厚度",	"下一步", "宽度", "阈值","读取位置","半径 A", "深度 A", "厚度 A", "公差","第一个角度", "最后一个角度", "清除包络", "校准", "重新开始", "接受", "参考幅度", "增益补偿", "应用", "幅度", "增加点", "焊缝类型", "厚度", "编码器", "参考点", "距离", "分辨率"
};
